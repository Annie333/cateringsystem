            ...
            <ul class="nav" id="main-menu">
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="BalconyOrder.jsp" class="active-menu waves-effect waves-dark"><i class="fa fa-dashboard"></i>包厢</a>
                        </li>
                        <li>
        ...
        <div id="page-inner">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    <div class="card blue-grey darken-1">
                        <div class="card-content white-text">
                            <span class="card-title">B01</span>
                            <p>可容纳人数：10</p>
                            <p>当前状态：已接单</p>
                        </div>
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="card blue-grey darken-1">
                        <div class="card-content white-text">
                            <span class="card-title">B02</span>
                            <p>可容纳人数：5</p>
                            <p>当前状态：空</p>
                        </div>
                        <div class="card-action">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="card blue-grey darken-1">
                        <div class="card-content white-text">
                            <span class="card-title">B03</span>
                            <p>可容纳人数：5</p>
                            <p>当前状态：空</p>
                        </div>
                        <div class="card-action">
